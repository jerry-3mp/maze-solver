...
class MazeBuilderTest {
    ...
    class DimensionStageTests {
        ...
        void heightRejectsInvalidValues(int height) {
            ...
            Exception exception = assertThrows(IllegalArgumentException.class, 
                () -> MazeBuilder.builder().height(height));
    ...
    class PositionStageTests {
        ...
        void startShouldSetStartPosition() {
            ...
            MazeBuilder.PositionStage stage = MazeBuilder.builder()
                .height(10).width(10).start(1, 1);
            assertNotNull(stage);
        }
        ...
        void endShouldSetEndPosition() {
            ...
            MazeBuilder.PathStage stage = MazeBuilder.builder()
                .height(10).width(10).start(1, 1).end(8, 8);
            assertNotNull(stage);
        }
        ...
        void randomStartAndEndShouldSetRandomPositions() {
            // In the implemented version, this should not throw and return PathStage
            MazeBuilder.PathStage stage = MazeBuilder.builder()
                .height(10).width(10).randomStartAndEnd();
            assertNotNull(stage);
        }
    }
